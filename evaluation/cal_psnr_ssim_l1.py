...
if __name__ == '__main__':
    folder1 = '/home/daxu/下载/test_双mamba推理_500_200/results/test/out_img'  # path to the inpainted result
    folder2 = '/home/daxu/下载/test_双mamba推理_500_200/results/test/gt_img1'  # path to the out
