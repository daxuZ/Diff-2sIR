...
parser.add_argument('--sd15_path', default='experiments/checkpoint/stable-diffusion-v1-5', help="Stable diffusion 1.5 for text tokenizer and encoder for SingDiffusion")
parser.add_argument('--sd_model_path', default='experiments/checkpoint/stable-diffusion-v1-5', help="Pre-trained base diffusion model")
parser.add_argument('--sing_diffusion_path', default='experiments/checkpoint/SingDiffusion', help="Pre-trained SingDiffusion")
